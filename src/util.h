...
#ifndef WACOINS_UTIL_H
#define WACOINS_UTIL_H
...
#ifdef WIN32
typedef HANDLE wacoins_pthread_t;

inline wacoins_pthread_t CreateThread(void(*pfn)(void*), void* parg, bool fWantHandle=false)
{
    DWORD nUnused = 0;
    HANDLE hthread =
        CreateThread(
    ...
    if (hthread == NULL)
    {
        ...
        return (wacoins_pthread_t)0;
    }
    if (!fWantHandle)
    {
        CloseHandle(hthread);
        return (wacoins_pthread_t)-1;
    }
    return hthread;
}
