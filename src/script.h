...
#ifndef H_WACOINS_SCRIPT
#define H_WACOINS_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CWACoinsAddress
 */
...
public:
    ...
    // Pre-version-0.6, WACoins always counted CHECKMULTISIGs
