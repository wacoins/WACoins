        ...
        QWidget(parent)
{
    ...
    wacoins_at_startup = new QCheckBox(tr("&Start WACoins on window system startup"));
    wacoins_at_startup->setToolTip(tr("Automatically start WACoins after the computer is turned on"));
    layout->addWidget(wacoins_at_startup);
    ...
    map_port_upnp->setToolTip(tr("Automatically open the WACoins client port on the router. This only works when your router supports UPnP and it is enabled."));
    ...
    fee_edit = new WACoinsAmountField();
...
void MainOptionsPage::setMapper(MonitoredDataMapper *mapper)
{
    ...
    mapper->addMapping(wacoins_at_startup, OptionsModel::StartAtStartup);
#ifndef Q_WS_MAC
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show WACoins addresses in the transaction list"));
