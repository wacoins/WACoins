...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(WACoinsUnits::BTC)
    {
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = WACoinsUnits::formatWithUnit(unit, amount, true);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(qint64 balance, qint64 stake, qint64 unconfirmedBalance)
{
    ...
    ui->labelBalance->setText(WACoinsUnits::formatWithUnit(unit, balance));
    ui->labelStake->setText(WACoinsUnits::formatWithUnit(unit, stake));
    ui->labelUnconfirmed->setText(WACoinsUnits::formatWithUnit(unit, unconfirmedBalance));
}
