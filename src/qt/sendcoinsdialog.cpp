...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    {
        formatted.append(tr("<b>%1</b> to %2 (%3)").arg(WACoinsUnits::formatWithUnit(WACoinsUnits::BTC, rcp.amount), Qt::escape(rcp.label), rcp.address));
    }
    ...
    case WalletModel::AmountWithFeeExceedsBalance:
        QMessageBox::warning(this, tr("Send Coins"),
            ...
            arg(WACoinsUnits::formatWithUnit(WACoinsUnits::BTC, sendstatus.fee)),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
...
void SendCoinsDialog::handleURI(const QString &uri)
{
    ...
    if(!GUIUtil::parseWACoinsURI(uri, &rv))
    {
        return;
    }
    pasteEntry(rv);
